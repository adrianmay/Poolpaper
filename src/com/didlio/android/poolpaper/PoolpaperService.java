...
public class PoolpaperService extends GLWallpaperService {
	...
	public static final String SHARED_PREFS_NAME="poolpapersettings";
	...
	public Engine onCreateEngine() {
		return new PoolpaperEngine(this.getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE), this);
	}
